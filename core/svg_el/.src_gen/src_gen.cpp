...
std::string SVGCPP() {
    ...
    ss << "#include \"svg_element.h\"" << std::endl;
    ss << "" << std::endl;
    ...
    ss << "        ss << _inner_text << std::endl;" << std::endl;
    ss << "        for (auto &p : _inner_elements) {" << std::endl;
    ss << "            ss << p->outer_SVG() << std::endl;" << std::endl;
    ss << "        }" << std::endl;
