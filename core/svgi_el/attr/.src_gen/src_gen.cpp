...
const std::string AttributeH(const std::vector<std::string> &tags) {
    std::stringstream ss;
    ...
    ss << "        */" << std::endl;
    ss << "        Attribute(std::function<const std::string()> getter, std::function<void(const std::string &)> setter);" << std::endl;
    ss << "" << std::endl;
    ss << "        /**" << std::endl;
    ...
    ss << "        */" << std::endl;
    ss << "        template <typename T>" << std::endl;
    ss << "        Attribute &operator=(const T &attr);" << std::endl;
    ss << "" << std::endl;
    ss << "        /**" << std::endl;
...
const std::string AttributeCPP() {
    std::stringstream ss;
    ss << "#include \"attr.h\"" << std::endl;
    ss << "" << std::endl;
    ss << "namespace Lewzen {" << std::endl;
    ss << "    Attribute::Attribute() {}" << std::endl;
    ss << "    Attribute::Attribute(std::function<const std::string()> getter, std::function<void(const std::string &)> setter): _getter(getter), _setter(setter) {}" << std::endl;
    ss << "    const std::string Attribute::get() const {" << std::endl;
    ss << "        if (!_getter) return STR_NULL;" << std::endl;
    ss << "        return _getter();" << std::endl;
    ss << "    }" << std::endl;
    ss << "    const std::string Attribute::get_commit() const {" << std::endl;
    ss << "        if (!_commit) return STR_NULL;" << std::endl;
    ss << "        return _commit();" << std::endl;
    ss << "    }" << std::endl;
    ss << "    template <typename T>" << std::endl;
    ss << "    void Attribute::set(const T &attr) { _LZ_WARNING(\"Calling Attribute.set, but no implementation.\") }" << std::endl;
    ss << "    template <typename T>" << std::endl;
    ss << "    Attribute &Attribute::operator=(const T &attr) { _LZ_WARNING(\"Calling Attribute.operator=, but no implementation.\") }" << std::endl;
    ss << "    template <typename T>" << std::endl;
    ss << "    void Attribute::bind(std::function<const T> bind_func) { _LZ_WARNING(\"Calling Attribute.bind, but no implementation.\") }" << std::endl;
    ss << "    template <typename T>" << std::endl;
    ss << "    void Attribute::bind(const std::weak_ptr<T> &bind_ptr) { _LZ_WARNING(\"Calling Attribute.bind, but no implementation.\") }" << std::endl;
    ss << "    template <typename T>" << std::endl;
    ss << "    Attribute &Attribute::operator[](std::function<const T> bind_func) {" << std::endl;
    ss << "        bind(bind_func);" << std::endl;
    ss << "        return *this;" << std::endl;
    ss << "    }" << std::endl;
    ss << "    template <typename T>" << std::endl;
    ss << "    Attribute &Attribute::operator[](const std::weak_ptr<T> &bind_ptr) {" << std::endl;
    ss << "        bind(bind_ptr);" << std::endl;
    ss << "        return *this;" << std::endl;
    ss << "    }" << std::endl;
    ss << "    void Attribute::commit() {" << std::endl;
    ss << "        if (!_setter || !_commit) return;" << std::endl;
    ss << "        _setter(_commit());" << std::endl;
    ss << "    }" << std::endl;
    ss << "    void Attribute::callback_assign(std::function<void(const std::string &)> on_assign) { _on_assign = on_assign; }" << std::endl;
    ss << "    void Attribute::callback_assign() { _on_assign = [](const std::string &last){}; }" << std::endl;
    ss << "    void Attribute::callback_bind_func(std::function<void()> on_bind_func) { _on_bind_func = on_bind_func; }" << std::endl;
    ss << "    void Attribute::callback_bind_func() { _on_bind_func = [](){}; }" << std::endl;
    ss << "    void Attribute::callback_bind_ptr(std::function<void()> on_bind_ptr) { _on_bind_ptr = on_bind_ptr; }" << std::endl;
    ss << "    void Attribute::callback_bind_ptr() { _on_bind_ptr = [](){}; }" << std::endl;
    ss << "}" << std::endl;
    return ss.str();
}
...
public:
    ...
    const std::string in_cpp_file() {
        std::stringstream ss;
        ss << "    const std::string Attr" << dom_to_pascal(_type) << "::_from_con_val_" << std::regex_replace(_cname, std::regex("\\s"), "_") << "() {" << std::endl;
        ss << "        return " << std::regex_replace(_cname, std::regex("\\s"), "_") << "_to_string(_con_val_" << std::regex_replace(_cname, std::regex("\\s"), "_") << ");" << std::endl;
        ss << "    }" << std::endl;
        ss << "    const std::string Attr" << dom_to_pascal(_type) << "::_from_bind_func_" << std::regex_replace(_cname, std::regex("\\s"), "_") << "() {" << std::endl;
        ss << "        return " << std::regex_replace(_cname, std::regex("\\s"), "_") << "_to_string(_bind_func_" << std::regex_replace(_cname, std::regex("\\s"), "_") << "());" << std::endl;
        ss << "    }" << std::endl;
        ss << "    const std::string Attr" << dom_to_pascal(_type) << "::_from_bind_ptr_" << std::regex_replace(_cname, std::regex("\\s"), "_") << "() {" << std::endl;
        ...
        ss << "        else return STR_NULL;" << std::endl;
        ss << "    }" << std::endl;
        ss << "    std::string Attr" << dom_to_pascal(_type) << "::" << std::regex_replace(_cname, std::regex("\\s"), "_") << "_to_string(const " << _ctype << " &attr) {" << std::endl;
        ss << _to_string << std::endl;
        ss << "    }" << std::endl;
        ss << "    void Attr" << dom_to_pascal(_type) << "::set(const " << _ctype << " &attr) {" << std::endl;
        ...
        ss << "        _on_assign(_last);" << std::endl;
        ss << "    }" << std::endl;
        ss << "    Attr" << dom_to_pascal(_type) << " &Attr" << dom_to_pascal(_type) << "::operator=(const " << _ctype << " &attr) {" << std::endl;
        ss << "        _con_val_" << std::regex_replace(_cname, std::regex("\\s"), "_") << " = attr;" << std::endl;
        ss << "        auto _last = get_commit();" << std::endl;
        ss << "        _commit = std::bind(&Attr" << dom_to_pascal(_type) << "::_from_con_val_" << std::regex_replace(_cname, std::regex("\\s"), "_") << ", this);" << std::endl;
        ss << "        _on_assign(_last);" << std::endl;
        ss << "    }" << std::endl;
        if (_ctype == "std::string") { // consider char *
            ss << "    void Attr" << dom_to_pascal(_type) << "::set(const char *attr) {" << std::endl;
            ss << "        set(std::string(attr));" << std::endl;
            ss << "    }" << std::endl;
            ss << "    Attr" << dom_to_pascal(_type) << " &Attr" << dom_to_pascal(_type) << "::operator=(const char *attr) {" << std::endl;
            ss << "        operator=(std::string(attr));" << std::endl;
            ss << "    }" << std::endl;
        }
        ss << "    void Attr" << dom_to_pascal(_type) << "::bind(std::function<const " << _ctype << "()> bind_func) {" << std::endl;
        ...
        ss << "        _on_bind_func();" << std::endl;
        ss << "    }" << std::endl;
        ss << "    Attr" << dom_to_pascal(_type) << " &Attr" << dom_to_pascal(_type) << "::operator[](std::function<const " << _ctype << "()> bind_func) {" << std::endl;
        ss << "        _bind_func_" << std::regex_replace(_cname, std::regex("\\s"), "_") << " = bind_func;" << std::endl;
        ss << "        _commit = std::bind(&Attr" << dom_to_pascal(_type) << "::_from_bind_func_" << std::regex_replace(_cname, std::regex("\\s"), "_") << ", this);" << std::endl;
        ss << "        _on_bind_func();" << std::endl;
        ss << "        return *this;" << std::endl;
        ss << "    }" << std::endl;
        ss << "    void Attr" << dom_to_pascal(_type) << "::bind(const std::weak_ptr<" << _ctype << "> &bind_ptr) {" << std::endl;
        ...
        ss << "        _on_bind_ptr();" << std::endl;
        ss << "    }" << std::endl;
        ss << "    Attr" << dom_to_pascal(_type) << " &Attr" << dom_to_pascal(_type) << "::operator[](const std::weak_ptr<" << _ctype << "> &bind_ptr) {" << std::endl;
        ss << "        _bind_ptr_" << std::regex_replace(_cname, std::regex("\\s"), "_") << " = bind_ptr;" << std::endl;
        ss << "        _commit = std::bind(&Attr" << dom_to_pascal(_type) << "::_from_bind_ptr_" << std::regex_replace(_cname, std::regex("\\s"), "_") << ", this);" << std::endl;
        ss << "        _on_bind_ptr();" << std::endl;
        ss << "        return *this;" << std::endl;
...
const std::string HeaderFile(std::string typ, std::string comment, std::vector<std::string> includes, std::vector<Accept> accepts) {
    ...
    ss << "        * @param setter setter function" << std::endl;
    ss << "        */" << std::endl;
    ss << "        Attr" << dom_to_pascal(typ) << "(std::function<const std::string()> getter, std::function<void(const std::string &)> setter);" << std::endl;
    ss << "" << std::endl;
    ss << "        /**" << std::endl;
...
const std::string CPPFile(std::string typ, std::string comment, std::vector<Accept> accepts) {
    ...
    ss << "" << std::endl;
    ss << "namespace Lewzen {" << std::endl;
    ss << "    Attr" << dom_to_pascal(typ) << "::Attr" << dom_to_pascal(typ) << "() {}" << std::endl;
    ss << "    Attr" << dom_to_pascal(typ) << "::Attr" << dom_to_pascal(typ) << "(std::function<const std::string()> getter, std::function<void(const std::string &)> setter): _getter(getter), _setter(setter) {}" << std::endl;
    ss << "    void Attr" << dom_to_pascal(typ) << "::set_getter(std::function<const std::string()> getter) {" << std::endl;
    ss << "        _getter = getter;" << std::endl;
    ss << "    }" << std::endl;
    ss << "    void Attr" << dom_to_pascal(typ) << "::set_setter(std::function<void(const std::string &)> setter) {" << std::endl;
    ss << "        _setter = setter;" << std::endl;
    ss << "    }" << std::endl;
    ss << "    const std::string Attr" << dom_to_pascal(typ) << "::get() const {" << std::endl;
    ss << "        if (!_getter) return STR_NULL;" << std::endl;
    ss << "        return _getter();" << std::endl;
    ss << "    }" << std::endl;
    ss << "    const std::string Attr" << dom_to_pascal(typ) << "::get_commit() const {" << std::endl;
    ss << "        if (!_commit) return STR_NULL;" << std::endl;
    ss << "        return _commit();   " << std::endl;
    ss << "    }" << std::endl;
    ss << "    void Attr" << dom_to_pascal(typ) << "::commit() {" << std::endl;
    ss << "        if (!_setter || !_commit) return;" << std::endl;
    ss << "        _setter(_commit());" << std::endl;
    ss << "    }" << std::endl;
    ss << "    template <typename T>" << std::endl;
    ss << "    void Attr" << dom_to_pascal(typ) << "::set(const T &attr) {" << std::endl;
    ss << "        _setter(STR_NULL);" << std::endl;
    ss << "        _LZ_WARNING(\"Calling Attr" << dom_to_pascal(typ) << ".set with no implementation. Reset value.\")" << std::endl;
    ss << "    }" << std::endl;
    ss << "    template <typename T>" << std::endl;
    ss << "    Attr" << dom_to_pascal(typ) << " &Attr" << dom_to_pascal(typ) << "::operator=(const T &attr) {" << std::endl;
    ss << "        _setter(STR_NULL);" << std::endl;
    ss << "        _LZ_WARNING(\"Calling Attr" << dom_to_pascal(typ) << ".set with no implementation. Reset value.\")" << std::endl;
    ss << "    }" << std::endl;
    ss << "    template <typename T>" << std::endl;
    ss << "    void Attr" << dom_to_pascal(typ) << "::bind(std::function<const T()>bind_func) {" << std::endl;
    ss << "        _setter(STR_NULL);" << std::endl;
    ss << "        _LZ_WARNING(\"Calling Attr" << dom_to_pascal(typ) << ".set with no implementation. Reset value.\")" << std::endl;
    ss << "    }" << std::endl;
    ss << "    template <typename T>" << std::endl;
    ss << "    void Attr" << dom_to_pascal(typ) << "::bind(const std::weak_ptr<T> &bind_ptr) {" << std::endl;
    ss << "        _setter(STR_NULL);" << std::endl;
    ss << "        _LZ_WARNING(\"Calling Attr" << dom_to_pascal(typ) << ".set with no implementation. Reset value.\")" << std::endl;
    ss << "    }" << std::endl;
    ss << "    template <typename T>" << std::endl;
    ss << "    Attr" << dom_to_pascal(typ) << " &Attr" << dom_to_pascal(typ) << "::operator[](std::function<const T()>bind_func) {" << std::endl;
    ss << "        _setter(STR_NULL);" << std::endl;
    ss << "        _LZ_WARNING(\"Calling Attr" << dom_to_pascal(typ) << ".set with no implementation. Reset value.\")" << std::endl;
    ss << "    }" << std::endl;
    ss << "    template <typename T>" << std::endl;
    ss << "    Attr" << dom_to_pascal(typ) << " &Attr" << dom_to_pascal(typ) << "::operator[](const std::weak_ptr<T> &bind_ptr) {" << std::endl;
    ss << "        _setter(STR_NULL);" << std::endl;
    ss << "        _LZ_WARNING(\"Calling Attr" << dom_to_pascal(typ) << ".set with no implementation. Reset value.\")" << std::endl;
    ss << "    }" << std::endl;
    for (auto &a : accepts) ss << std::endl << a.in_cpp_file();
    ss << "    void Attr" << dom_to_pascal(typ) << "::callback_assign(std::function<void(const std::string &)> on_assign) { _on_assign = on_assign; }" << std::endl;
    ss << "    void Attr" << dom_to_pascal(typ) << "::callback_assign() { _on_assign = [](const std::string &last){}; }" << std::endl;
    ss << "    void Attr" << dom_to_pascal(typ) << "::callback_bind_func(std::function<void()> on_bind_func) { _on_bind_func = on_bind_func; }" << std::endl;
    ss << "    void Attr" << dom_to_pascal(typ) << "::callback_bind_func() { _on_bind_func = [](){}; }" << std::endl;
    ss << "    void Attr" << dom_to_pascal(typ) << "::callback_bind_ptr(std::function<void()> on_bind_ptr) { _on_bind_ptr = on_bind_ptr; }" << std::endl;
    ss << "    void Attr" << dom_to_pascal(typ) << "::callback_bind_ptr() { _on_bind_ptr = [](){}; }" << std::endl;
    ss << "}" << std::endl;
    ss << "#endif" << std::endl;
    return ss.str();
}
...
int main(int argc, char **argv) {
    ...
    o = std::ofstream(base_dir + "/attr.h");
    o << AttributeH(tags);
    o = std::ofstream(base_dir + "/attr.cpp");
    o << AttributeCPP();
