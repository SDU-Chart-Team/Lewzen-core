...
namespace Lewzen {
    ...
    template <typename T>
    void Percentage::bind(const T (*bind_func)()) {
        _setter(STR_NULL);
        _LZ_WARNING("Calling Attribute.set with no implementation. Reset value.")
    }
    template <typename T>
    ...
    template <typename T>
    Percentage &Percentage::operator[](const T (*bind_func)) {
        _setter(STR_NULL);
        _LZ_WARNING("Calling Attribute.set with no implementation. Reset value.")
    }
    template <typename T>
    ...
    void Percentage::bind(const int (*bind_func)()) {
        _bind_func_integer = bind_func;
        _commit = std::bind(&Percentage::_from_bind_func_integer, this);
    }
    Percentage &Percentage::operator[](const int (*bind_func)()) {
        _bind_func_integer = bind_func;
        _commit = std::bind(&Percentage::_from_bind_func_integer, this);
    }
    ...
    void Percentage::bind(const float (*bind_func)()) {
        _bind_func_float = bind_func;
        _commit = std::bind(&Percentage::_from_bind_func_float, this);
    }
    Percentage &Percentage::operator[](const float (*bind_func)()) {
        _bind_func_float = bind_func;
        _commit = std::bind(&Percentage::_from_bind_func_float, this);
    }
    ...
    void Percentage::bind(const double (*bind_func)()) {
        _bind_func_double = bind_func;
        _commit = std::bind(&Percentage::_from_bind_func_double, this);
    }
    Percentage &Percentage::operator[](const double (*bind_func)()) {
        _bind_func_double = bind_func;
        _commit = std::bind(&Percentage::_from_bind_func_double, this);
    }
    ...
    void Percentage::bind(const long (*bind_func)()) {
        _bind_func_long = bind_func;
        _commit = std::bind(&Percentage::_from_bind_func_long, this);
    }
    Percentage &Percentage::operator[](const long (*bind_func)()) {
        _bind_func_long = bind_func;
        _commit = std::bind(&Percentage::_from_bind_func_long, this);
    }
    ...
    void Percentage::bind(const long long int (*bind_func)()) {
        _bind_func_long_integer = bind_func;
        _commit = std::bind(&Percentage::_from_bind_func_long_integer, this);
    }
    Percentage &Percentage::operator[](const long long int (*bind_func)()) {
        _bind_func_long_integer = bind_func;
        _commit = std::bind(&Percentage::_from_bind_func_long_integer, this);
    }
    ...
    void Percentage::bind(const long double (*bind_func)()) {
        _bind_func_long_double = bind_func;
        _commit = std::bind(&Percentage::_from_bind_func_long_double, this);
    }
    Percentage &Percentage::operator[](const long double (*bind_func)()) {
        _bind_func_long_double = bind_func;
        _commit = std::bind(&Percentage::_from_bind_func_long_double, this);
    }
    ...
    void Percentage::bind(const std::string (*bind_func)()) {
        _bind_func_legal_string = bind_func;
        _commit = std::bind(&Percentage::_from_bind_func_legal_string, this);
    }
    Percentage &Percentage::operator[](const std::string (*bind_func)()) {
        _bind_func_legal_string = bind_func;
        _commit = std::bind(&Percentage::_from_bind_func_legal_string, this);
    }
