...
const std::string EnumerateHPP(const std::vector<std::string> &tags) {
    ...
    ss << "            _LZ_WARNING(\"Found unsupported ctype \\\"\" << typeid(u).name() << \"\\\" in Enumerate, which only supports SVG attributes.\");" << std::endl;
    ss << "            return STR_NULL;" << std::endl;
    ss << "        }" << std::endl;
    for (auto &tag : tags) {
        ss << "        const std::string __commit_impl(" << dom_to_pascal(tag) << " &u) const {" << std::endl;
    ...
    ss << "        */" << std::endl;
    ss << "        Enumerate() {}" << std::endl;
    ss << "" << std::endl;
    ss << "        /**" << std::endl;
    ss << "        * Constructor of Enumerate" << std::endl;
    ss << "        */" << std::endl;
    ss << "        Enumerate(std::function<const std::string()> getter, std::function<void(const std::string &)> setter): _getter(getter), _setter(setter) {" << std::endl;
    ...
    ss << "        }" << std::endl;
    for (auto &tag : tags) {
        ss << "        void _EnumerateImpl(" << dom_to_pascal(tag) << " &u, std::function<const std::string()> getter, std::function<void(const std::string &)> setter) {" << std::endl;
    ...
    for (auto &tag : tags) {
         ss << "        template<typename T>" << std::endl;
        ss << "        void _set_impl(const T &attr, " << dom_to_pascal(tag) << " &u) {" << std::endl;
    ...
    ss << "        */" << std::endl;
    ss << "        template <typename T>" << std::endl;
    ss << "        Enumerate<Ts...> &operator=(const T &attr) {" << std::endl;
    ...
    for (auto &tag : tags) {
         ss << "        template<typename T>" << std::endl;
        ss << "        void _op1_impl(const T &attr, " << dom_to_pascal(tag) << " &u) {" << std::endl;
        ss << "            u = attr;" << std::endl;
        ss << "        }" << std::endl;
    }
    ss << "" << std::endl;
    ...
    for (auto &tag : tags) {
         ss << "        template<typename T>" << std::endl;
        ss << "        void _bind1_impl(std::function<const T()>bind_func, " << dom_to_pascal(tag) << " &u) {" << std::endl;
    ...
    ss << "        */" << std::endl;
    ss << "        template <typename T>" << std::endl;
    ss << "        Enumerate<Ts...> &operator[](std::function<const T()>bind_func) {" << std::endl;
    ss << "            _op2<T, 0, Ts...>(bind_func);" << std::endl;
    ss << "            return *this;" << std::endl;
    ss << "        }" << std::endl;
    ss << "        template <typename T>" << std::endl;
    ss << "        Enumerate<Ts...> &operator[](const T(*bind_func)()) {" << std::endl;
    ss << "            std::function<const T()> _bind_func = bind_func;" << std::endl;
    ...
    ss << "        }" << std::endl;
    ss << "        template <typename T>" << std::endl;
    ss << "        Enumerate<Ts...> &operator[](T bind_func) {" << std::endl;
    ss << "            auto p = lambda_to_function(bind_func);" << std::endl;
    ss << "            __op2(p);" << std::endl;
    ss << "        }" << std::endl;
    ss << "        template<typename T, std::size_t i, typename L>" << std::endl;
    ...
    for (auto &tag : tags) {
         ss << "        template<typename T>" << std::endl;
        ss << "        void _op2_impl(std::function<const T()>bind_func, " << dom_to_pascal(tag) << " &u) {" << std::endl;
    ...
    for (auto &tag : tags) {
         ss << "        template<typename T>" << std::endl;
        ss << "        void _bind2_impl(const std::weak_ptr<T> &bind_ptr, " << dom_to_pascal(tag) << " &u) {" << std::endl;
    ...
    ss << "        */" << std::endl;
    ss << "        template <typename T>" << std::endl;
    ss << "        Enumerate<Ts...> &operator[](const std::weak_ptr<T> &bind_ptr) {" << std::endl;
    ...
    for (auto &tag : tags) {
         ss << "        template<typename T>" << std::endl;
        ss << "        void _op3_impl(const std::weak_ptr<T> &bind_ptr, " << dom_to_pascal(tag) << " &u) {" << std::endl;
