...
const std::string HeaderFile(std::string typ, std::string comment, std::vector<std::string> includes, std::vector<Accept> accepts) {
    ...
    ss << "    private:" << std::endl;
    ss << "        const std::string (*_commit)();" << std::endl;
    ss << "        const std::string (*_getter)();" << std::endl;
    ss << "        void (*_setter)(const std::string &);" << std::endl;
    ss << "    public:" << std::endl;
    ss << "        /**" << std::endl;
    ...
    ss << "        */" << std::endl;
    ss << "        " << dom_to_pascal(typ) << "(const std::string (*getter)(), void (*setter)(const std::string &));" << std::endl;
    ss << "" << std::endl;
    ss << "        /**" << std::endl;
...
const std::string CPPFile(std::string typ, std::string comment, std::vector<Accept> accepts) {
    ...
    ss << "    " << dom_to_pascal(typ) << "::" << dom_to_pascal(typ) << "(const std::string (*getter)(), void (*setter)(const std::string &)): _getter(getter), _setter(setter) {}" << std::endl;
    ss << "    const std::string " << dom_to_pascal(typ) << "::get() const {" << std::endl;
    ss << "        if (_getter == nullptr) return STR_NULL;" << std::endl;
    ...
    ss << "        if (_setter == nullptr || _commit == nullptr) return;" << std::endl;
