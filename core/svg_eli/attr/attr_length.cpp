...
namespace Lewzen {
    ...
    void Length::set_getter(std::function<const std::string()> getter) {
        _getter = getter;
    }
    void Length::set_setter(std::function<void(const std::string &)> setter) {
        _setter = setter;
    }
    ...
    template <typename T>
    void Length::bind(std::function<const T()>bind_func) {
        _setter(STR_NULL);
        _LZ_WARNING("Calling Attribute.set with no implementation. Reset value.")
    }
    template <typename T>
    ...
    template <typename T>
    Length &Length::operator[](std::function<const T()>bind_func) {
        _setter(STR_NULL);
        _LZ_WARNING("Calling Attribute.set with no implementation. Reset value.")
    }
    template <typename T>
    ...
    void Length::bind(std::function<const int()> bind_func) {
        _bind_func_integer = bind_func;
        _commit = std::bind(&Length::_from_bind_func_integer, this);
    }
    Length &Length::operator[](std::function<const int()> bind_func) {
        _bind_func_integer = bind_func;
        _commit = std::bind(&Length::_from_bind_func_integer, this);
    }
    ...
    void Length::bind(std::function<const float()> bind_func) {
        _bind_func_float = bind_func;
        _commit = std::bind(&Length::_from_bind_func_float, this);
    }
    Length &Length::operator[](std::function<const float()> bind_func) {
        _bind_func_float = bind_func;
        _commit = std::bind(&Length::_from_bind_func_float, this);
    }
    ...
    void Length::bind(std::function<const double()> bind_func) {
        _bind_func_double = bind_func;
        _commit = std::bind(&Length::_from_bind_func_double, this);
    }
    Length &Length::operator[](std::function<const double()> bind_func) {
        _bind_func_double = bind_func;
        _commit = std::bind(&Length::_from_bind_func_double, this);
    }
    ...
    void Length::bind(std::function<const long()> bind_func) {
        _bind_func_long = bind_func;
        _commit = std::bind(&Length::_from_bind_func_long, this);
    }
    Length &Length::operator[](std::function<const long()> bind_func) {
        _bind_func_long = bind_func;
        _commit = std::bind(&Length::_from_bind_func_long, this);
    }
    ...
    void Length::bind(std::function<const long long int()> bind_func) {
        _bind_func_long_integer = bind_func;
        _commit = std::bind(&Length::_from_bind_func_long_integer, this);
    }
    Length &Length::operator[](std::function<const long long int()> bind_func) {
        _bind_func_long_integer = bind_func;
        _commit = std::bind(&Length::_from_bind_func_long_integer, this);
    }
    ...
    void Length::bind(std::function<const long double()> bind_func) {
        _bind_func_long_double = bind_func;
        _commit = std::bind(&Length::_from_bind_func_long_double, this);
    }
    Length &Length::operator[](std::function<const long double()> bind_func) {
        _bind_func_long_double = bind_func;
        _commit = std::bind(&Length::_from_bind_func_long_double, this);
    }
    ...
    void Length::bind(std::function<const std::string()> bind_func) {
        _bind_func_legal_string = bind_func;
        _commit = std::bind(&Length::_from_bind_func_legal_string, this);
    }
    Length &Length::operator[](std::function<const std::string()> bind_func) {
        _bind_func_legal_string = bind_func;
        _commit = std::bind(&Length::_from_bind_func_legal_string, this);
    }
